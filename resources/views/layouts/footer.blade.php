<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
    <div class="container d-flex flex-column flex-md-row align-items-center justify-content-between">
        <div class="text-dark order-2 order-md-1">
            ...
            <a href="https://instagram.com/art_by_mansi_patel" class="text-dark-75 text-hover-primary">{{
                config('app.name', 'Laravel') }}</a>
        </div>

        <div class="font-size-h5 font-weight-bolder order-1 order-md-2 py-2 py-md-0">Made with <span
            ...
            </span>by <a href="http://instagram.com/p_d_0309" class="text-primary" target="_blank">Paresh Parmar</a>
        </div>
    </div>
</div>
